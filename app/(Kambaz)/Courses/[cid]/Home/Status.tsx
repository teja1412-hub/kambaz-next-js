import { MdAnalytics, MdAnnouncement, MdDoNotDisturbAlt, MdHome, MdNotifications, MdStream } from "react-icons/md";
import { FaCheckCircle } from "react-icons/fa";
import { BiCloudDownload, BiImport } from "react-icons/bi";
...
export default function CourseStatus() {
  return (
    <div id="wd-course-status" style={{ width: "350px" }}>
      ...
      <Button variant="secondary" size="lg" className="w-100 mt-1 text-start">
        <BiCloudDownload className="me-2 fs-5" /> Import from Commons{" "}
      </Button>
      <Button variant="secondary" size="lg" className="w-100 mt-1 text-start">
