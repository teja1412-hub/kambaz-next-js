    ...
    <div id="wd-lab1">
      ...
      <div id="wd-lists">
        ...
        <ol id="wd-your-favorite-recipe">
          <li>Heat the pan.</li>
          <li>Let any water residue evaporate.</li>
          <li>Pour a few drops of oil and spread it across the pan.</li>
          <li>
            Take a scoop of dosa batter and add it to the pan while continuing
            to make outward swirls with the ladle after pouring the batter.
          </li>
          <li>
            Pour a few more drops of oil around the edges and over the dosa.
          </li>
          <li>Flip it when it gets crisp.</li>
          <li>
            Serve it hot, when it turns into golden colour and enjoy with your
            favourite chutney!
          </li>
        </ol>
        ...
        <ul id="wd-your-books">
          <li>Hounds of Bakersville</li>
          <li>The Lost Key</li>
          <li>Private</li>
          <li>Immortals of Meluha</li>
      ...
      <div id="wd-forms">
        ...
        <br />
        Click <a href="https://github.com/teja1412-hub/kambaz-next-js" id="wd-github">here</a> to follow the github repository of Kambaz app.
      </div>
    </div>
  );
}
